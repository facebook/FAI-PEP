...
class RunBenchUnitTest(unittest.TestCase):
    ...
    def test_getUnknownArgs(self):
        ...
        expected = {"--remote": None, "-b": "/home/mobilenet_v3.json",
                    "--platform": "android", "--framework": "pytorch",
                    "--devices": "SM-G981U1-11-30", "--buck_target": None}
        ...
        expected = {"--remote": "True", "-b": None, "--platform": "android",
                    "--framework": "pytorch", "--devices": "SM-G981U1-11-30",
                    "--buck_target": None}
        self.assertEqual(self.app._getUnknownArgs(), expected)
        ...
        expected = {"--remote": None, "-b": None, "--platform": None,
                    "--framework": None, "-d": None, "--buck_target": None,
                    "-c": None, "-e": None}
        self.assertEqual(self.app._getUnknownArgs(), expected)
        ...
        expected = {"--remote": None, "-b": None, "--platform": "android",
                    "--framework": "pytorch",
